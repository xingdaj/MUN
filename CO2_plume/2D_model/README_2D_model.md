...
## Suggested citation/use statement

If you use this code in academic work, please cite the related paper or manuscript describing the Bayesian waveform inversion, normalizing-flow posterior approximation, and two-stage control-point pruning strategy.
