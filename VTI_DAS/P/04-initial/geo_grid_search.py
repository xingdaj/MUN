...
def main(argv=None) -> None:
    ...
    p.add_argument("--x-min", type=float, default=450.0)
    p.add_argument("--x-max", type=float, default=950.0)
    p.add_argument("--z-min", type=float, default=400.0)
    p.add_argument("--z-max", type=float, default=820.0)
    ...
    p.add_argument("--objective", default="diff-p-reference", choices=["absolute", "diff-p-adjacent", "diff-p-reference"])
