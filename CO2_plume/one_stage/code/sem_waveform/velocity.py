...
def _closed_bspline_from_ctrl(ctrl6_xy: np.ndarray, degree: int = 3):
    """
    Construct the same closed periodic cubic B-spline used by the model
...
def closed_bspline_curve_points(ctrl_xy: np.ndarray, samples: int = 800, degree: int = 3, close: bool = True):
