...
class SEMSimulation:
 ...
 #print("==== Velocity Parameters ====")
    ...
    def _clamped_basis_values_collapsed(self, ctrl_points, u, degree=3, ctrl_closed=None, knots=None):
        """
    ...
    def _analytical_gradient_projection_improved(
        ...
        B, _, _ = self._clamped_basis_values_collapsed(ctrl, u_hat, degree=3)
